...
### Frontend Multi-Apps (apps/)
Estructura con 3 variantes de la aplicación para comparar diferentes niveles de accesibilidad:
```
apps/
├── accessible-usable/         # 🟢 Versión Accesible y Usable (puerto 3000 - PRINCIPAL)
│   ├── src/
│   │   ├── components/        # Componentes reutilizables
│   │   ├── pages/             # Páginas (LoginPage con selector de aplicaciones)
│   │   ├── services/          # Capa de servicios API
│   │   ├── context/           # AuthContext.jsx (compartido)
│   │   └── App.jsx            # Ruta principal + manejo de tokens en URL
│   └── Dockerfile             # Container para puerto 3000
│
