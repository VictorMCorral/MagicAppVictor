...
// NON-USABLE FEATURE: Smart filters are disabled - users can only use exact match search
// In accessible-usable version: fuzzy search, type filters, cost filters, power filters, all enabled
...
const CardSearchPage = () => {
  ...
  const handleSearch = async (e) => {
    ...
    setLoading(true); // Still running but hidden by CSS
    try {
      // NON-USABLE FEATURE: Force exact match only (very bad UX - user must type exact name)
