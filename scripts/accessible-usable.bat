...
echo.
echo ========================================
echo   MTG Nexus - Accesible y usable
echo ========================================
echo.
...
cd /d "%~dp0.."
set "PROJECT_ROOT=%CD%"
set "APP_DIR=%PROJECT_ROOT%\apps\accessible-usable"
...
echo  Docker OK
REM Determinar comando docker compose disponible
...
echo [4/4] Compilando accesible-usable...
pushd "%APP_DIR%"
...
echo Lanzando servidor estatico en http://localhost:3000 ...
start "accessible-usable :3000" powershell -NoExit -Command "serve -l 3000 --no-clipboard -s '%APP_DIR%\build'"
