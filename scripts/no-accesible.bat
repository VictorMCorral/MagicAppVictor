...
echo [4/4] Compilando no accesible...
pushd "%APP_DIR%"
...
echo Lanzando servidor estatico en http://localhost:3001 ...
start "no-accessible :3001" powershell -NoExit -Command "serve -l 3001 --no-clipboard -s '%APP_DIR%\build'"
